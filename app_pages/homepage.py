...
st.markdown("##### 3. Sample Size Estimator")
...
st.markdown("##### 4. Campaign Duration Simulator")
...
st.markdown("##### 5. Intersect Impressions Estimator")
st.write('Estimate the impressions needed for a campaign to generate a statistically signifcant result in Intersect.')

st.markdown("##### 6. Matched Market Analysis Tool")
st.write('Select the best test and control market pairs for an A/B test.')

st.markdown("##### 7. Minimum Detectable Effect")
st.write('Minimum Detectable Effect (MDE) informs the minimum lift you can reliably detect in an A/B test.')
