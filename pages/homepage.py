...
st.markdown("##### 5. QA Tool")
st.write('Easily compare two files automatically in just a few clicks. This tool highlights differences, helping you ensure data accuracy and consistency with minimal effort.')