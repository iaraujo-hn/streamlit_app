...
st.markdown("---")
st.write('**Statistical Significance Test** tool is designed to help you determine whether observed differences between two independent groups (e.g., Group A vs. Group B) are statistically significant.')

st.write("**Ideal Use Case:**  Post A/B test campaign analysis")
