...
st.markdown('<a href="pages/2_Significance Test.py" class="link">1. Significance Testing</a>', unsafe_allow_html=True)
...
st.markdown('<a href="pages/3_Sample Size Estimator.py" class="link">2. Sample Size Estimator</a>', unsafe_allow_html=True)
...
st.markdown('<a href="pages/4_Campaign Duration Simulator.py" class="link">3. Campaign Duration Simulator</a>', unsafe_allow_html=True)
